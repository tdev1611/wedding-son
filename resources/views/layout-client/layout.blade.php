...
<body id="home" data-spy="scroll" data-target="#navbar-wd" data-offset="98">
    ...
    <header class="top-header">
        <nav class="navbar header-nav navbar-expand-lg">
            <div class="container">
                {{-- {{ url('public/theme-client/images/logo.jpg') }} --}}
                <a class="navbar-brand" href="{{ route('homes') }}"><img
                        src="{{ url('public/theme-client/images/logo.jpg') }}" alt="image"></a>
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbar-wd">
                    <ul class="navbar-nav">
                        <li><a class="nav-link {{ request()->is('/') ? 'active' : '' }}"
                                href="{{ route('homes') }}">Trang chủ</a></li>
                        {{-- <li><a class="nav-link" href="#about">Thông tin về Studio</a></li> --}}
                        <li><a class="nav-link {{ request()->is('thong-tin-studio') ? 'active' : '' }}"
                                href="{{ route('story.index') }}">Thông tin Studio</a></li>
                        {{-- story.index --}}
                        {{-- <li><a class="nav-link" href="#family">Family</a></li> --}}
                        <li><a class="nav-link {{ request()->is('team-building') ? 'active' : '' }}"
                                href="{{ route('tbuilding.index') }}">Team building</a></li>
                        ...
                        <div class="contact-block">
                            <form id="contactForm">
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <textarea class="form-control" id="message" placeholder="Dịch vụ bạn muốn chụp" rows="8"
                                                data-error="Write your message" required></textarea>
                                            <div class="help-block with-errors"></div>
                                        </div>
                                        <div class="submit-button text-center">
                                            <button class="btn btn-common" id="submit" type="submit">Gửi thông
                                                tin</button>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <p class="footer-company-name"> 2023 Design By : <a target="_blank"
                            href="https://www.facebook.com/BugCreatordmBug/">Đức Hải</a> - Studio Diễm My : <a
                            target="_blank" href="https://www.facebook.com/son.phamong">Phạm Ông Sơn</a></p>
                </div>
                <div class="col-lg-12">
